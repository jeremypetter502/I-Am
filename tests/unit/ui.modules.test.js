...
describe('UI module integration', () => {
  it('includes aesthetics, music, and delivery modules in ContextFile when responses provided', () => {
    ...
    const ctx = toContextFile(scored, { aesthetics: aestResponses, music: musicResponses, delivery: deliveryResponses });
